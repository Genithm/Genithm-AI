...
revoke all on function public.claim_analysis_job(text, integer), public.renew_analysis_job_lease(uuid, text, integer), public.finish_analysis_job_success(uuid, text, jsonb, text, text, jsonb, text, timestamptz, jsonb), public.finish_analysis_job_error(uuid, text, text, boolean) from public, anon, authenticated;
